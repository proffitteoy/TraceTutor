...
export const Message: FC<MessageProps> = ({
  ...
  const MODEL_DATA = allModelData.find(llm => llm.modelId === message.model) as
    | LLM
    | undefined
  ...
  const modelDetails = allModelData.find(
  ...
  const shouldShowGeneratingState =
    !firstTokenReceived &&
    isGenerating &&
    isLast &&
                  ...
                  <WithTooltip
                    ...
                    trigger={
                      <ModelIcon
                        ...
                        modelId={modelDetails?.modelId || message.model}
                        modelName={modelDetails?.modelName || message.model}
                        height={ICON_SIZE}
                        width={ICON_SIZE}
                      />
                    }
        ...
        {fileItems.length > 0 && (
          <div className="border-primary mt-6 border-t pt-4 font-bold">
            {!viewSources ? (
              ...
              >
                {fileItems.length}
                {fileItems.length > 1 ? " 条来源 " : " 条来源 "}
                来自 {Object.keys(fileSummary).length} 个
                {Object.keys(fileSummary).length > 1 ? "文件" : "文件"}
